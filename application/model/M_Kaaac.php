 ...
 * Time: 上午9:48
 */
class M_Kaaac extends Model {
    function __construct() {
        $this->table = TB_PREFIX.'aac_ka';
        parent::__construct();
    }
    ...
    public function getAppArtListByPage($pageSize=10,$current=1,$sort,$like,$where){
        $field = array('id','name','title','keywords','icon','nstatus','status','count','creater','content','verifyer','u_time','c_time','v_time','level','setting');
        return $this->Field($field)->tabPage($pageSize,$current,$sort,$like,$where);
    }
