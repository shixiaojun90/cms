...
class HardnewsController extends BasicController {
    ...
    public function tabPageAction(){
        try{
            //查询
			$sort='id desc';
            $data=$this->m_hardnews->getAppArtListByPage($_POST['rowCount'],$_POST['current'],$sort,$_POST['searchPhrase'],null);
    ...
    public function getArticleByIdAction(){
        try{
            //查询
            $data=$this->m_hardnews->getArticlebyId($_GET['id']);
            Helper::response('0',$data);
        }catch (Exception $ex){
            Helper::response('1006',$ex);
        }
    ...
    public function addAction(){
        try{
            ...
            $data=$this->m_hardnews->Insert($ret);
    ...
    public function deleteAction(){
        try{
            $result = $this->m_hardnews->DeleteByID($_POST['id']);
    ...
    public function updateByIdAction(){
        try{
            ...
            $data=$this->m_hardnews->UpdateByID($ret,$_POST['id']);
            Helper::response('0',$data);
        }catch (Exception $ex){
            Helper::response('1006',$ex);
        }
